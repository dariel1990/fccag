    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <form class="max-w-3xl space-y-6" @submit.prevent="submit">
            ...
            <div class="grid gap-2">
                ...
                <p class="text-xs text-muted-foreground">URL: /blog/{{ autoSlug }}</p>
            ...
            <div class="flex items-center gap-4 pt-2">
                ...
                <Button variant="outline" as="a" :href="index()">Cancel</Button>
                <a
                    :href="`/blog/${post.slug}`"
                    target="_blank"
                    class="ml-auto text-sm text-muted-foreground hover:text-primary transition-colors"
                >
                    View on site →
                </a>
            </div>
