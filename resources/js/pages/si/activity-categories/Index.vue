...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'SI Activity Categories', href: index().url },
];
...
function deleteCategory(category: Category) {
    if (
        confirm(
            `Delete "${category.name}"? This will remove all associated SI activities.`,
        )
    ) {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                <Heading
                    title="SI Activity Categories"
                    description="Manage scoring categories and their weights"
                />
